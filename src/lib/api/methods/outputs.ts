...
export const deleteOutput = (id: string) =>
  alovaInstance.Delete(`/outputs/${id}`)

// 输出预览
export const previewOutput = (id: string) =>
  alovaInstance.Get(`/outputs/${id}/preview`)

// 输出生成
export const renderOutput = (id: string) =>
  alovaInstance.Get(`/outputs/${id}/render`)
